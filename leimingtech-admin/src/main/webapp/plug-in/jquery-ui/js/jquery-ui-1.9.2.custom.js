...
$.widget( "ui.tabs", {
	...
	// Remove this function in 1.10 when ajaxOptions is removed
...
if ( $.uiBackCompat !== false ) {
	...
	//  Remove _ajaxSettings() method when removing this extension
...
$.fn.extend({
	effect: function( /* effect, options, speed, callback */ ) {
		...
		// remove this check in 2.0, effectMethod will always be true
		if ( effectMethod ) {
