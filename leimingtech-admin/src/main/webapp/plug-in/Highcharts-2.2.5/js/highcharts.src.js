...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// : If the WebKit team fix this bug before the final release of Chrome 18, remove the workaround.
...
Chart.prototype = {
	 ...
	 */
	// This method is called setSize in the api
...
Point.prototype = {
	...
	applyOptions: function (options, x) {
		 ...
		 */
		// : skip this? It is only used in applyOptions, in translate it should not be used
...
Series.prototype = {
	...
	render: function () {
		...
		// : since creating the clip property, the clipRect is created but
