...
function fileQueueError(file, errorCode, message) {
	try {
		...
		case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
			...
			this.debug("错误码: 文件太大, 文件名: " + file.name + ", 文件大小: " + file.size + ", 信息: " + message);
			break;
		case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
			progress.setStatus("零字节文件无法上传.");
			this.debug("错误码: 零字节文件, 文件名: " + file.name + ", 文件大小: " + file.size + ", 信息: " + message);
			break;
		case SWFUpload.QUEUE_ERROR.INVALID_FILETYPE:
			progress.setStatus("无效的文件类型.");
			this.debug("错误码: 无效的文件类型, 文件名: " + file.name + ", 文件大小: " + file.size + ", 信息: " + message);
			break;
		default:
			if (file !== null) {
...
function uploadError(file, errorCode, message) {
	try {
		...
		case SWFUpload.UPLOAD_ERROR.HTTP_ERROR:
			...
			this.debug("错误码: HTTP 错误, 文件名: " + file.name + ", 信息: " + message);
			break;
		...
		case SWFUpload.UPLOAD_ERROR.IO_ERROR:
			...
			this.debug("错误码: IO Error, 文件名: " + file.name + ", 信息: " + message);
			break;
		case SWFUpload.UPLOAD_ERROR.SECURITY_ERROR:
			progress.setStatus("安全错误");
			this.debug("错误码: 安全错误, 文件名: " + file.name + ", 信息: " + message);
			break;
		case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
			progress.setStatus("上传限制超标.");
			this.debug("错误码: 上传限制超标, 文件名: " + file.name + ", 文件大小: " + file.size + ", 信息: " + message);
			break;
