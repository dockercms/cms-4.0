...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var available_height = $(window).height() - $('.footer').height()-$('.header ').height();
            ...
            if (body.hasClass('page-sidebar-fixed')) {
	    	 ...
	    	 var available_height = $(window).height() - $('.footer').innerHeight()-$('.header ').height();
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                if (sub.is(":visible")) {
                	$(this).children("i:eq(0)").removeClass("icon-folder-open");
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            var date = new Date();
            date.setTime(date.getTime() + (60 * 1000*60*24*30*60));
            $.cookie('style_color', color,{expires: date });                
        }
        ...
        if($.cookie('style_color')){
        	setColor($.cookie('style_color'));//设置上次选择的皮肤
        }
    ...
    return {
        ...
        getLayoutColorCode: function (name) {
        	...
        	if(handleSidebarMenuStartCount>0){
        		return;
        	}
        	handleSidebarMenu();
        	handleSidebarMenuStartCount++;
        }

    };

}();
var handleSidebarMenuStartCount=0;