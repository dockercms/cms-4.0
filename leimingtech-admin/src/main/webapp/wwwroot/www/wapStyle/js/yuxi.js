...
//		 }
	 ...
	 if (browser.versions.ios || browser.versions.iPhone
		...
		//$("#checkNewApp").html("<p style=\"padding: 15px;\">检查更新<span style=\"float: right;font-size: 12px;\">已经是最新版</span></p>");
		 $("#checkNewApp").hide();
	}
			...
			var $div2=$("<div class='ui-btn-text'>");
  			...
  			if(obj.Attribute!=''){
  				...
  				for(var j=0;j<attrArray.length;j++){
  					...
  					if(attrArray[j]=="video"){
  						var video_img="<img src=\"/images/video001.png\" style=\"height: 14px;vertical-align: baseline;margin:0px 3px;\">";
  						$h3.html(video_img+obj.Title);
						break;
  					}
  				}
  			}
