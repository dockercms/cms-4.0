			...
			openMedia : function ( index ) {
				...
				if ( ! $this.isVideo( src ) ) {
					...
					$this.loadMedia( src, function() {
						...
						slide.html( this );
						var temp="<span class='index'>"+(index+1)+"/"+elements.length+"</span>";
							temp+="<h3 class='title'>"+elements[ index ].title+"</h3>";
							if(elements[ index ].content!="null" && elements[ index ].content!=''){
								temp+="<p class='content'>"+elements[ index ].content+"</p>";
							}
						slide.append("<div class='bottom_info'>"+temp+"</div>");
					} );
				} else {
