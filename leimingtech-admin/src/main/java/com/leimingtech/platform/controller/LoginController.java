...
//            update-end--Author:zhangguoming  Date:20140226 for：添加验证码
            ...
            if (users == 0) {
                ...
                if (u != null) {
                    ...
                    if (true) {
                		String logInfo = "["+u.getUserName()+"]登录成功";
...
//        update-end--Author:zhangguoming  Date:20140226 for：添加验证码
	...
	public ModelAndView logout(HttpServletRequest request) {
		...
		String logInfo = "["+u.getUserName()+"]已退出登陆";
	...
	private Map<String, TSFunction> getUserFunction(TSUser user) {
		...
		if (client.getFunctions() == null) {
			...
			for (TSRoleUser ru : rUsers) {
				TSRole role = ru.getTSRole();
				List<TSRoleFunction> roleFunctionList = userService
...
//				org.lmcmsframework.core.util.LogUtil.info(function.getFunctionName());
//				org.lmcmsframework.core.util.LogUtil.info(function.getFunctionLevel());
