 ...
 * @Description: 文档分类
 * @author 
 * @date 2014-06-11 13:14:23
 * @version V1.0   
 *
 */
@Entity
@Table(name = "cms_doc_type", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class DocTypeEntity  extends IdEntity implements java.io.Serializable {
	 ...
	 *@return: java.lang.String  文档分类名称
	 */
