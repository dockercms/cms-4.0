...
enum RandCodeImageEnum {
	 ...
	 * 混合字符串
	 */
	ALL_CHAR("23456789abcdefghijkmnpqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ"),
	/**
	 * 字符
	 */
	LETTER_CHAR("abcdefghijkmnpqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ"),
	/**
	 * 小写字母
	 */
	LOWER_CHAR("abcdefghijkmnpqrstuvwxyz"),
	/**
	 * 数字
	 */
