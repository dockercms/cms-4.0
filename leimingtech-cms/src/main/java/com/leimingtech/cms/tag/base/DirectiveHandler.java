...
public class DirectiveHandler {
     ...
     */
    public DirectiveHandler(Environment environment,
                            Map<String, TemplateModel> parameters, TemplateModel[] loopVars,
     ...
     * @throws TemplateException
     */
    public void renderIfNotNull(Object notEmptyObject) throws IOException,
            TemplateException {
     ...
     * @return
     */
    public DirectiveHandler putAll(Map<String,Object> m) {
        map.putAll(m);
        return this;
    }
    ...
    private Map<String, TemplateModel> reduce() throws TemplateModelException {
        ...
        for (String key : map.keySet()) {
            ...
            environment.setVariable(key,
                    environment.getObjectWrapper().wrap(map.get(key)));
        }
        return reduceMap;
    }
    ...
    public Boolean getBoolean(String name) throws TemplateException {
        ...
        if (model instanceof TemplateBooleanModel) {
            ...
            return !(0 == ((TemplateNumberModel) model).getAsNumber()
                    .intValue());
        } else if (model instanceof TemplateScalarModel) {
            String s = ((TemplateScalarModel) model).getAsString();
    ...
    public Date getDate(String name) throws TemplateException {
        ...
        if (model instanceof TemplateDateModel) {
            ...
            String temp = StringUtils.trimToEmpty(((TemplateScalarModel) model)
                    .getAsString());
            try {
