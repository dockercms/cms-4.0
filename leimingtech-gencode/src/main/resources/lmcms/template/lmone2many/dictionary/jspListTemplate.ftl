					  ...
					  <${'#'}list ${entityName?uncap_first}List as ${entityName?uncap_first}>
						...
						<#list columns as po>
							...
							<td style="text-align:center;"> 
								...
								<#list subTab as sub>
								<input type='button' class="managerbtn" title='管理' onclick="toEditModel('${entityName?uncap_first}Controller.do?${sub.entityName?uncap_first}&${sub.foreignKeys[1]?uncap_first}=${'$'}{${entityName?uncap_first}.id?if_exists}')" />
								</#list>
							</td>
						</tr>
					  </${'#'}list> 
...
<div id="editModel" class="modal hide fade" tabindex="-1"  data-backdrop="static" data-width="800"></div>
