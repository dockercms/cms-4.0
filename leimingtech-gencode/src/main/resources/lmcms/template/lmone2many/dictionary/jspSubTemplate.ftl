...
<div class="modal-body">
	...
	<form id="${entityName?uncap_first}_form" class="form-horizontal">
		...
		<#list columns as po>
		<#if po.fieldName!='id' && po.fieldName!=foreignKeys[1]?uncap_first>
...
<div class="modal-footer">
	<input type="button" onclick="formSubmitModelSub('${parentEntityName?uncap_first}Controller.do?save${entityName}', '${entityName?uncap_first}_form');" class="btn btn-primary" value="提交">
