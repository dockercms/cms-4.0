...
import com.leimingtech.gencode.codegenerate.generate.onetomany.dataCodeGenerateOneToMany;
 ...
 *
 */
public class OneToManyMainUtilModel1 {
	...
	public static void main(String[] args) {
		...
		codeParamEntityIn.setEntityPackage("cla");	 //主表[包名]
