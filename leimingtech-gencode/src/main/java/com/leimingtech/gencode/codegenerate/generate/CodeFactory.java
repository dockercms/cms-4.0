...
public class CodeFactory extends BaseCodeFactory{
	...
	public enum CodeType {serviceImpl("ServiceImpl"),
		service("ServiceI"), controller("Controller"), entity("Entity"),html(""),ftlList("List"),editModel("editModel"),show("Show");
		private String type;
	...
	public String getCodePath(String type, String entityPackage,
		...
		if (StringUtils.isNotBlank(type)) {
			...
			str.append(path);
				if("show".equals(type)||"html".equals(type)||"ftlList".equals(type)||"editModel".equals(type)){
				...
				if ("Action".equalsIgnoreCase(codeType)) {
					...
					//设置为空
				}else if("editModel".equalsIgnoreCase(codeType)){
					
				}else if("Show".equalsIgnoreCase(codeType)){
