...
public class dataCodeFactoryOneToMany extends BaseCodeFactory{
	...
	public enum CodeType {serviceImpl("ServiceImpl"),
		dao("Dao"), service("ServiceI"), controller("Controller"), page("Page"), entity("Entity"),html(""),ftlList("List"),jspSubList("SubList");
		private String type;
	...
	public String getCodePath(String type, String entityPackage,
		...
		if (StringUtils.isNotBlank(type)) {
			...
			str.append(path);
				if("html".equals(type)||"ftlList".equals(type)){
