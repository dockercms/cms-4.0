package com.leimingtech.core.extend.template;
...
//					{
//						org.lmcmsframework.core.util.LogUtil.info(tt);
//					}
...
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("1+2*3+7.5-(4/2+8)/5"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
        
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("110815.00047*2"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("110815.125047*2"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
        
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("((110815.0347)*2+10)/0"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
        
        
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("0.02"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
//        org.lmcmsframework.core.util.LogUtil.info(calc.transInfixToPosfix("0.0"));
//        org.lmcmsframework.core.util.LogUtil.info("value is:"+calc.calc());
