 ...
 */
@Entity
@Table(name = "cms_complaints_report", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
public class ComplaintsReportEntity extends IdEntity implements java.io.Serializable {

	private static final long serialVersionUID = 3809802267325603586L;
	/** 姓名 */
