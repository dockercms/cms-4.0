 ...
 */
@Entity
@Table(name = "cm_video", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class ContentVideoMobileEntity extends IdEntity implements java.io.Serializable {
	...
	/**移动视频分类id*/
	private java.lang.String videoclassifyid;
	/**创建时间*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  移动视频分类id
	 */
	@Column(name ="VIDEOCLASSIFYID",nullable=true,length=32)
	public java.lang.String getVideoclassifyid(){
		return this.videoclassifyid;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  移动视频分类id
	 */
	public void setVideoclassifyid(java.lang.String videoclassifyid){
