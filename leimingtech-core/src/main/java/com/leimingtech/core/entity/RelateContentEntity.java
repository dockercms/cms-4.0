 ...
 * @Description: 相关内容
 * @author zhangdaihao
 * @date 2014-05-13 15:08:13
 * @version V1.0   
 *
 */
@Entity
@Table(name = "cms_relate_content", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class RelateContentEntity extends IdEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="RELATE_URL",nullable=true,length=500)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  区分内容id
	 */
