 ...
 */
@Entity
@Table(name = "cms_email_address", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
public class EmailAddressEntity extends IdEntity implements java.io.Serializable {

	private static final long serialVersionUID = 5009940639081595118L;
	/** 姓名 */
