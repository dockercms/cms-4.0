 ...
 * @Description: 调查日志选项
 * @author 
 * @date 2014-06-11 09:13:18
 * @version V1.0   
 *
 */
@Entity
@Table(name = "cms_survey_log_data", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SurveyLogDataEntity extends IdEntity implements java.io.Serializable {
	...
	/**选项内容id*/
	private java.lang.String optionextid;
	/**回复*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  调查日志id
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  选项内容id
	 */
	@Column(name ="OPTIONEXTID",nullable=true,length=32)
	public java.lang.String getOptionextid(){
		return this.optionextid;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  选项内容id
	 */
	public void setOptionextid(java.lang.String optionextid){
