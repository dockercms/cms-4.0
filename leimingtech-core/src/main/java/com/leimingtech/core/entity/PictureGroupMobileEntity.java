 ...
 */
@Entity
@Table(name = "cm_picture_group", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class PictureGroupMobileEntity  extends IdEntity implements java.io.Serializable {
	...
	/**移动图片分类id*/
	private java.lang.String pictureclassifyid;
	/**创建时间*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  移动图片分类id
	 */
	@Column(name ="PICTURECLASSIFYID",nullable=true,length=32)
	public java.lang.String getPictureclassifyid(){
		return this.pictureclassifyid;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  移动图片分类id
	 */
	public void setPictureclassifyid(java.lang.String pictureclassifyid){
		this.pictureclassifyid = pictureclassifyid;
	}
	/**
	 *方法: 取得java.lang.Date
