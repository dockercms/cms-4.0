...
public class ImageJDKUtil {
	 ...
	 *            水印位置 用1-9表示，0代表随机
	 */
	public static void pressText(String targetImg, String pressText, String fontName, int fontStyle, int color, int fontSize, int x, int y) {
		try {
			File _file = new File(targetImg);
			Image src = ImageIO.read(_file);
			int wideth = src.getWidth(null);
...
//		ImageJDKUtil.pressImage("D:/11111.jpg","D:/qqqq.png" , 0);
		pressText("d:/a.png", "111222333JK", "宋体", 0, 0, 12, 167, 150);
	}
