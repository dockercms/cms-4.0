...
import com.leimingtech.core.def.ConstantsDefs;
...
public class LmcmsSqlUtil {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		String projectPath = getAppPath(LmcmsSqlUtil.class);
...
//		返回读取指定资源的输入流   
        InputStream is = LmcmsSqlUtil.class.getResourceAsStream(sqlurl);    
...
//		org.lmcmsframework.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	@Test
	public void test() {
		//org.lmcmsframework.core.util.LogUtil.info(getAppPath(LmcmsSqlUtil.class));
		LogUtil.info(getCountSqlBySql("SELECT * 	from LMCMS_DICT_PARAM WHERE 1=1"));
	}
