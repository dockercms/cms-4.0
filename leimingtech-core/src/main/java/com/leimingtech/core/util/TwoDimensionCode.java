...
import com.leimingtech.core.entity.TwoDimensionCodeImage;
...
public class TwoDimensionCode {
    ...
    public void encoderQRCode(String content, String imgPath, String imgType) {  
        this.encoderQRCode(content, imgPath, imgType, 9);
    }  
    ...
    public boolean encoderQRCode(String content, String imgPath, String imgType, int size) {
        try {  
            ...
            imgPath.replace( "\\", "/" );
            String fileDir = StringUtils.substringBeforeLast(imgPath, "/");
