...
//		ImageMagickUtil.scaleFixedImageFileWhite("D:/324x27001.jpg", "D:/324x27002.jpg", 400, 400);
		//原图  , 水印  
//		ImageMagickUtil.pressImage("D:/aaaa.jpg","D:/qqqq.png" , 0,0);
//		
//		// 压缩图String imagePath,int quality,String newImagePath
//		ImageMagickUtil.compression("D:/222.jpg", 75, "D:/2333.jpg");
		
		ImageMagickUtil.scaleRateImageFile2("D:/temp/DSC02118.JPG", "D:/temp/a.jpg", 1024, 1024);
...
//		ImageMagickUtil.qualityImg(fromFileName, toFileName,"75");
	...
	public static boolean scaleRateImageFile2(String fromFileName, String toFileName, int toWidth, int toHeight)
	{
		System.setProperty("jmagick.systemclassloader", "no");
		ImageInfo info = null;
		MagickImage fromImage = null;
...
//				throw new Exception("CMYK TO RGB 错误！");
	...
	public static void pressText(String filePath, String pressText, int color, int fontSize, int x, int y) {
		System.out.print("ImageMagickUtil正在打文字水印--" + filePath);
		System.setProperty("jmagick.systemclassloader", "no");
		MagickImage image = null;
		try {
			...
			// drawInfo.setUnderColor(PixelPacket.queryColorDatabase("white"));
			drawInfo.setOpacity(0);
			drawInfo.setPointsize(fontSize);
