...
import com.leimingtech.core.annotation.LmcmsEntityTitle;
...
import com.leimingtech.core.entity.DBTable;
import com.leimingtech.core.hibernate.qbc.CriteriaQuery;
import com.leimingtech.core.hibernate.qbc.DetachedCriteriaUtil;
import com.leimingtech.core.hibernate.qbc.HqlQuery;
import com.leimingtech.core.hibernate.qbc.PageList;
import com.leimingtech.core.hibernate.qbc.PagerUtil;
import com.leimingtech.core.util.LogUtil;
import com.leimingtech.core.util.MyBeanUtils;
import com.leimingtech.core.util.ToEntityUtil;
import com.leimingtech.core.util.oConvertUtils;
import com.leimingtech.core.util.exception.BusinessException;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	public List<DBTable> getAllDbTableName() {
		...
		for (String key : (Set<String>) metaMap.keySet()) {
			...
			try {
				c = Class.forName(key);
				LmcmsEntityTitle t = c.getAnnotation(LmcmsEntityTitle.class);
	...
	public PageList getPageList(final CriteriaQuery cq, final boolean isOffset) {
		...
		return new PageList(criteria.list(), toolBar, offset, curPageNO,pageSize,
				allCounts);
	}
	...
	public PageList getPageListBySql(final HqlQuery hqlQuery,
		...
		return new PageList(hqlQuery, list, offset, curPageNO,hqlQuery.getPageSize(), allCounts);
	}
	...
	public PageList getPageList(final HqlQuery hqlQuery,
		...
		query.setFirstResult(offset);
		query.setMaxResults(hqlQuery.getPageSize());
		return new PageList(query.list(), toolBar, offset, curPageNO,hqlQuery.getPageSize(), allCounts);
	}
	...
	public <T> List<T> findForList(String sql, Class<T> elementType, Object... args){
	...
	public List<Map<String, Object>> findForJdbc(String sql, int page, int rows) {
		// 封装分页SQL
		sql = JdbcDao.lmcmsCreatePageSql(sql, page, rows);
	...
	public <T> List<T> findObjForJdbc(String sql, int page, int rows,
		...
		// 封装分页SQL
		sql = JdbcDao.lmcmsCreatePageSql(sql, page, rows);
		List<Map<String, Object>> mapList = jdbcTemplate.queryForList(sql,objs);
