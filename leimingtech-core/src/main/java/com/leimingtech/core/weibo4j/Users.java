package com.leimingtech.core.weibo4j;

import com.leimingtech.core.weibo4j.model.PostParameter;
import com.leimingtech.core.weibo4j.model.User;
import com.leimingtech.core.weibo4j.model.WeiboException;
import com.leimingtech.core.weibo4j.org.json.JSONArray;
import com.leimingtech.core.weibo4j.org.json.JSONObject;
...
public class Users extends Weibo{
	...
	public User showUserById(String uid) throws WeiboException {
		return new User(client.get("https://api.weibo.com/2/users/show.json",
	 ...
	 * @throws WeiboException
	 */
	public JSONObject removeOauth(String token) throws WeiboException {
		return client.get("https://api.weibo.com/oauth2/revokeoauth2", 
				new PostParameter[] { new PostParameter("access_token", token)}).asJSONObject();
	}
