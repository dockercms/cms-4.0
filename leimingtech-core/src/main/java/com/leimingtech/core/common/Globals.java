...
public final class Globals {
	 ...
	 * 保存用户到SESSION
	 */
	public static String CONTEXTPATH="/lmcms";
	/**
	 * 保存用户到SESSION
	 */
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 static{
		 String button_authority_lmcms = ResourceUtil.getSessionattachmenttitle("button.authority.lmcms");
		 if("true".equals(button_authority_lmcms)){
