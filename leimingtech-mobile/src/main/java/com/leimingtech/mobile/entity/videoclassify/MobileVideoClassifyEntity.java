package com.leimingtech.mobile.entity.videoclassify;
 ...
 */
@Entity
@Table(name = "cm_video_classify", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class MobileVideoClassifyEntity extends IdEntity implements java.io.Serializable {
